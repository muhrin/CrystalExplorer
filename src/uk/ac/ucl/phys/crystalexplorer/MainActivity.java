...
public class MainActivity extends FragmentActivity implements AtomsSelectionFragment.AtomSelectionListener {
	...
	public void onStructurePredicted(String structurePath, Bundle atomInfoBundle) {
		JmolFragment jmol = (JmolFragment)getSupportFragmentManager().findFragmentById(R.id.jmol_fragment);
		if(jmol != null) {
            ...
            JmolFragment jmolFragment = new JmolFragment();
            Bundle args = new Bundle();
            args.putString(AtomInfoKeys.STRUCTURE_PATH, structurePath);
            args.putBundle(AtomInfoKeys.ATOMS_INFO, atomInfoBundle);
            jmolFragment.setArguments(args);
        
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();

            // Replace whatever is in the fragment_container view with this fragment,
            // and add the transaction to the back stack so the user can navigate back
            transaction.replace(R.id.fragment_container, jmolFragment);
