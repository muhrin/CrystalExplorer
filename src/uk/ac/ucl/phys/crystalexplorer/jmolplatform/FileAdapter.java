...
public class FileAdapter implements JmolFileAdapterInterface {
	...
	private void outputBytes(URLConnection conn, byte[] bytes)
			throws IOException {
	...
	private void outputString(URLConnection conn, String post)
			throws IOException {
