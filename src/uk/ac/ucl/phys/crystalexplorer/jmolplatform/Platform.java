...
public class Platform implements ApiPlatform {
	...
	public Platform() {
		myFont = new Font(scaleFactor);
	}

	public void setViewer(JmolViewer viewer, Object display) {
		((UpdateListener) display).setViewer(viewer);
	}

	// /// Display -- JmolUpdateListener
	...
	public void getFullScreenDimensions(Object display, int[] widthHeight) {
		((UpdateListener) display).getScreenDimensions(widthHeight);
	}
	...
	public void repaint(Object display) {
		((UpdateListener) display).repaint();
	}
	...
	public JmolMouseInterface getMouseManager(Viewer viewer,
	...
	public Object allocateRgbImage(int windowWidth, int windowHeight,
		...
		return Image.allocateRgbImage(windowWidth, windowHeight, pBuffer,
				windowSize, backgroundTransparent, isImageWrite);
	}
	...
	public void drawImage(Object graphic, Object img, int x, int y, int width,
			int height) {
	...
	public int[] drawImageToBuffer(Object gOffscreen, Object imageOffscreen,
		...
		return Image.drawImageToBuffer(gOffscreen, imageOffscreen, imageobj,
