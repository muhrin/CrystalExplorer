...
public class JmolPlatform implements ApiPlatform {

  public void setViewer(JmolViewer viewer, Object display) {
    ((JmolUpdateListener)display).setViewer(viewer);
  }
  ...
  public void getFullScreenDimensions(Object display, int[] widthHeight) {
    ((JmolUpdateListener) display).getScreenDimensions(widthHeight);    
  }
  ...
  public void repaint(Object display) {
    ((JmolUpdateListener) display).repaint();
  }
  ...
  @Override
  public Object allocateRgbImage(
		int windowWidth,
		int windowHeight,
	    int[] pBuffer,
	    int windowSize,
	...
	return Image.allocateRgbImage(windowWidth, windowHeight, pBuffer, windowSize, backgroundTransparent, isImageWrite);
  }
